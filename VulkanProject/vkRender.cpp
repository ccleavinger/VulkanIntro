...
VkFormat VkRenderer::findSupportedFormat(const std::vector<VkFormat>& canidates, VkImageTiling tiling, VkFormatFeatureFlags features)
{
...
uint32_t VkRenderer::findMemoryType(uint32_t typeFilter, VkMemoryAllocateFlags properties)
{
...
void VkRenderer::createUniformBuffers()
{
    ...
    //  VK_MEMORY_PROPERTY_HOST_VISIBLE_BI
...
void VkRenderer::createImage(uint32_t width, uint32_t height, uint32_t mipLevels, VkSampleCountFlagBits numSamples, VkFormat format, VkImageTiling tiling,
    ...
    VkImageLayout newLayout, uint32_t mipLevels)
{
    ...
    barrier.subresourceRange.baseMipLevel = mipLevels;
...
void VkRenderer::generateMipmaps(VkImage image, VkFormat format, int32_t texWidth, int32_t texHeight, uint32_t mipLevels)
{
...
VkSampleCountFlagBits VkRenderer::getMaxUsableSampleCount()
{
...
void VkRenderer::createFPSCounter()
{
